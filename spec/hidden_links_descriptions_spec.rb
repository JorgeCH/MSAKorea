...
feature "hidden links" do
	...
	context "anonymous users" do
		scenario "cannot see the New Description Link" do
			visit projects_path
			assert_no_link_for "New Description"
		end
	...
	context "regular users" do
		before { log_in!(user) }
		scenario "can see the New Description Link" do
			visit '/projects'
			assert_link_for "New Description"
		end
